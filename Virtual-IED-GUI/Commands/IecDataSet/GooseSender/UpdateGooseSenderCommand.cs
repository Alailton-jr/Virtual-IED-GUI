...
{
    internal class UpdateGooseSenderCommand : CommandBase
    {
        ...
        public UpdateGooseSenderCommand(ConfigGooseSenderViewModel viewData, GooseSenderStore gooseSenderStore, ModalNavegationStore modalNavegationStore) 
        {
            _viewData = viewData;
        ...
        {
            _gooseSenderStore.UpdateGooseData(_viewData.GoData);
